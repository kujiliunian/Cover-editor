<template>
    <div class="header-box">
        <div class="flex items-center px-2 header-bar" style="height: 100%">
            <div class="flex-1 flex items-center">
                <img src="/logo.webp" style="width: 25px"/>
...
import AspectRatio from './left/aspectRatio.vue'
