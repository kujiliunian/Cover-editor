...
<!--                        <component :is="item.icon" class="icon" :size="24"/>-->
                      ...
                      <div style="width: 24px;height: 24px"> <m-s-icon :name="item.icon" class="icon" :size="24"/></div>
                ...
                <help>
                    <ul class="b-classify-wrap">
                        <li :class="['b-classify-item']">
                          <div style="width: 24px;height: 24px"> <m-s-icon name="question2" class="icon" :size="24"/></div>
            ...
            <div v-show="active" class="s-side-wrap">
                <a-tooltip effect="dark" content="收起侧边栏" placement="right">
                    <div class="pack__up" @click="active = false"><m-s-icon name="arrow-left" :size="12"  color="#FBFBFB"></m-s-icon></div>
                </a-tooltip>
            </div>
        </div>
    </a-layout-sider>
